...
function howManyDays(data){
  ...
  let msDistance = today - data
  return Math.floor(msDistance/ms)
}
console.log(`Sono trascorsi ${howManyDays(new Date("2020, 9, 10"))} giorni dalla data indicata`)
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
console.log("ESERCIZIO 10")
function isTodayMyBirthday(oggi) {
  let birthDay = new Date("2002, 10, 15")
...
console.log(deleteProp({nome: "Andrea", cognome: "Bardi", anni: "20"}, "nome"))
/* ESERCIZIO 12
