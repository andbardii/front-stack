    ...
    books.forEach((book) => {
        ...
        <div class="card">
            ...
            <div class="card-body mb-5">
                ...
                <button href="#" class="btn btn-dark">BUY NOW</button>
                <button href="#" id="deleteButton" class="btn btn-danger">DELETE</button>
                <button href="#" id="addToBasket" class="btn btn-success">
                ...
                <button href="#" id="removeFromBasket" class="btn btn-dark">
